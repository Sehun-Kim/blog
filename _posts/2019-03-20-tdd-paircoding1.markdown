...
# 초보 개발자 TDD를 만나다.
갈피를 잡지못하고 방황하던 작년 7월, 주니어 개발자들의 아이돌(?) [이동욱님의 글](https://jojoldu.tistory.com/277?category=689637)을 보고 '**코드스쿼드 웹백엔드 코스**'를 알게 되었다. 글을 보고 해당 교육이 내게 좋은 전환점이 될 것 같아, 그해 9월부터 코드스쿼드를 다니기 시작했다.
